    ...
    If (($SendConnector).ToString().Length -gt 0) {
        ForEach ($Item in $SendConnector) {
            ...
            Else {
                ...
                # Prop5
                If ($Item.$($Prop5).ToString() -eq $ExpectedValue5) {
                    $FindingDetails += "$($Prop5):`t`t`t$($Item.$($Prop5).ToString())" | Out-String
                }
                Else {
                    $Compliant = $false
                    $FindingDetails += "$($Prop5):`t`t`t$($Item.$($Prop5).ToString()) [Expected $($ExpectedValue5)]" | Out-String
                }
                $FindingDetails += "" | Out-String
            }
        }
...
Function Get-V221242 {
    ...
    .DESCRIPTION
        ...
        CheckMD5   : 5E9F54B86209DF661C722799DCDDCB23
...
Function Get-V221259 {
    ...
    #---=== Begin Custom Code ===---#
    If (($TransportService | Measure-Object).Count -gt 1) {
        $Status = "NotAFinding"
    ...
    ForEach ($Item in $TransportService) {
        $FindingDetails += "$($Item.Name)" | Out-String
        $FindingDetails += "ExchangeVersion:`t$($Item.ExchangeVersion.ExchangeBuild)" | Out-String
        $FindingDetails += "" | Out-String
    }
    #---=== End Custom Code ===---#
...
Function Get-V221262 {
    ...
    If (($SendConnector).ToString().Length -gt 0) {
        ForEach ($Item in $SendConnector) {
            $FindingDetails += "$($Item.Name)" | Out-String
            If ($Item.$($Prop1)) {
                $FindingDetails += "$($Prop1):`t$($Item.$($Prop1).Domain)" | Out-String
                $FindingDetails += "$($Prop2):`t$($Item.$($Prop2))" | Out-String
                If ($Item.$($Prop2) -eq $true) {
                ...
                Else {
                    ...
                    If (($Item.$($Prop3) | Measure-Object).Count -ge $ExpectedValue3) {
                        ...
                        If ($Item.$($Prop5).ToString() -eq $ExpectedValue5) {
                            $FindingDetails += "$($Prop5):`t$($Item.$($Prop5).ToString())" | Out-String
                        }
                        Else {
                            $Compliant = $false
                            $FindingDetails += "$($Prop5):`t$($Item.$($Prop5).ToString()) [Expected $($ExpectedValue5)]" | Out-String
                        }
                    }
                }
            }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBpv0PmugCNJll1
# PoyUfgctq/O5Ku4iKUFTRDyM4pnJVKCCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCDcka2wQT6QibJe1PG47r3MuGWgqPrkqYJISlV2zPAX2DANBgkqhkiG9w0BAQEF
# AASCAQAFa6kcEeOQVjtIu3GTY7G1bxqqULPy5wFNYca5droiK99KMdsu6yUsHpEA
# xpzBAWx0ypgp55H1WkGMsIMyqr78U0aSc6C5f6Ffb+cVeR+02LSQeVElVLsmjhlQ
# fuDoFVNE5MBoz9WeZ9q0+OhdswJAwsDxWBdNd9onqoSGk7qwc3xBFTV8YEIuTcub
# i5tQ7kbPJYW/Bw3aD8yBvfunaYsNaI2nO4qnDtu91DSFnKqMTqcStfvXaFGxHzsT
# x8tglltakO35hWrlKNZd2najn/nnZOVTKgpwzE+vOjI4EUMckeWfack6/oiIxixF
# fv/RXDfYKzG3zxgAIgehI509btgHoYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MDkxNTEwNTYwOVowLwYJKoZIhvcNAQkEMSIEIDkpoZ9vf22N70vHtdzjarD4g+5+
# XgmN7b1eZ/mbwI81MA0GCSqGSIb3DQEBAQUABIICAFd89BqKA5viEHiAIL69gaCP
# AzrlBp3IioPwkSe4vsPFZyfReG6p2sJpfXei9hfS4A6ZYYNAotslZKJTl9Paar5q
# gHklgecbS5MbyrzBX+EmcOnNezqDsNajPoluv45+aHKhWE/8xdhaeWXFtzdDaDs6
# M8z/IG3URZAQVKuteNrpcq2+HqyCDJ+pzkuKuRP7p6kssLf5xrU95Z3pU53AdAbQ
# R87GZ7lYTJKh6vO1Vy5GqSVa9kjF7XwSUrJSEn5qGWod5JLpxaaDFkziHDNvKDI5
# geRDgC1H/FJTlH9myhg3ZvWo7HPqGjjnqpAWgsGapGY0HQurwwlny1KwU5DQDAxi
# 5cDhIwsDw8guvExKrQkLjq2M9/0pWytetpQkh71LU6slajU+UEPE7X3oPEmnnQLB
# RNtiUXZYCF2j2+xgsw39oLtx12O4VQtqeSVNvrfF3UcuKJXc5j2Gkojin4A8C487
# gF0PDEUQ02XRdB/v/G7SlXNcT63N3gHCbNyAz3r4h/RWAkAP5h+uwi1aFKfW+DFs
# tKwUV8DRnRVkZlbmcTnBpp2rb0yEE0p+d6BLnQ0dSRF0ynRDNWEc/rsp/a3cqOOr
# o6rzvJ/OAR6uirsWiKib8sqlgz1hJeQC03GK9JuQerWup7L/adEz8K/cmWW/KMMY
# v9pfOdRq14iil1o9a2Rk
