...
Function Get-V235719 {
    ...
    .DESCRIPTION
        ...
        CheckMD5   : 6CE98C9DBB81611E12BC61EF98A556FF
        FixMD5     : 6F2E2609761074C73A1DCA47C1061F7E
    #>
...
Function Get-V235741 {
    ...
    .DESCRIPTION
        ...
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
        Rule Title : AutoplayAllowed must be set to disabled.
        DiscussMD5 : D21C1D42B9F1171190B34F8E9487D285
...
Function Get-V235752 {
    ...
    .DESCRIPTION
        ...
        DiscussMD5 : 1EAC33F8DD50B8328252F01A19EEC456
        CheckMD5   : 0051C5BB1265588C0C9A4AD14805B438
        FixMD5     : 00CD1F9949D86EE43A71EE8B321E2B98
    #>
    ...
    Else {
        ...
        $SettingState = "Enabled with (1)'BlockDangerousDownloads' or (2)'Block potentially dangerous or unwanted downloads' or (3)'Block all downloads' or (4) 'Block malicious downloads'"  # GPO configured state identified in STIG.
        $SettingNotConfiguredAllowed = $false  # Set to true if STIG allows for setting to be Not Configured.
...
Function Get-V235753 {
    ...
    .DESCRIPTION
        ...
        Rule Title : URLs must be allowlisted for plugin use if used.
...
Function Get-V251694 {
    ...
    Else {
        ...
        Else {
            ...
            $FindingDetails += "===========================" | Out-String
            ForEach ($SiteObject in $ListOfSites) {
                $FindingDetails += "`t$($Site)" | Out-String
                If ($SiteObject.Trim() -notin $ExpectedSites) {
                    $Compliant = $false
                }
            }
...
Function Get-V266981 {
    <#
    .DESCRIPTION
        Vuln ID    : V-266981
        STIG ID    : EDGE-00-000068
        Rule ID    : SV-266981r1007489_rule
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
        Rule Title : FriendlyURLs must be disabled.
        DiscussMD5 : 026FEF156ABE767CD5AC2D3812BB6455
        CheckMD5   : 4E2D37417F44F4E347387400FC8BC799
        FixMD5     : 2FCEB84A02A402155E549BC827B6C638
    #>
    ...
    $TempUserHivePath = ""  # User's loaded hive to perform check
    $RegistryPath = "HKLM:\SOFTWARE\Policies\Microsoft\Edge"  # Registry path identified in STIG
    $RegistryValueName = "ConfigureFriendlyURLFormat"  # Value name identified in STIG
    $RegistryValue = @("1")  # Value expected in STIG (if REG_DWORD/REG_QWORD use hex and remove leading 0x000...)
    $RegistryType = "REG_DWORD"  # Value type expected in STIG
    $SettingName = "Configure the default paste format of URLs copied from Microsoft Edge, and determine if additional formats will be available to users"  # GPO setting name identified in STIG
    $SettingState = "Enabled: (The plain URL without any extra information, such as the page's title.)"  # GPO configured state identified in STIG.
    $SettingNotConfiguredAllowed = $false  # Set to true if STIG allows for setting to be Not Configured.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAE4e3E6Hxb/hDZ
# BCqNdDjkBe1XKw3iZYGgyFp5UIXDn6CCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCCMAq4oy3mkJGNJsJUAT34xdBujUuGJ/4JGFsqqBpbVMDANBgkqhkiG9w0BAQEF
# AASCAQBEqL6UcOY+uhNUTHiJvfje3gbAMK+pHDZq3nWwodkXVwT9+365rBmZzK5o
# lOi/YemLuL0Iu6z9S/EUX+HGDrfpNe44595DEykDrdCVZKGVDNL4JlaZLQhOx2UQ
# ccW92JHvS1afvBdGfCeYp41eQnYVX/Z+MKZvPoZ9Jfm6rRypIZpzOA2bowpKWXhu
# VnSUB1MELNjGaYo5EznUntEUhDOy0JYEcUMSLToAseJyLzlP6X6Xlax7isV1pD0p
# 7zTx2gOhE3aedvl5QdVZ0N69FaZOyuYd9KH6Blh3WGZJDgXt7ljX8l0XsZ9A4pzu
# 7YGf9h8VnuExZDEPgk0CKpNOyElFoYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MDkxNTEwNTU1NVowLwYJKoZIhvcNAQkEMSIEICyzKf1wRnFOzxNSLNZ6szCdqeQ6
# QygZ6NgLh72txeClMA0GCSqGSIb3DQEBAQUABIICAB9hTGy48TJabt9BH18H1Jcb
# ES0yc2LTMaNgv9Onz7wOrctOEwokojvRQuWtQG5oyCoJSAWkTWGDOyUERDtrRCOD
# T3sUoZbTxw1dBRRf20yZNwjXdCt+MVuzryCpvCyg24pvYDzj+SDcBwS0pN9cSg49
# 92R+keKfC2SeecwAUISSkWWDyWbD7Y6gc1sl3v/xs9WNyWd20iItBrzGjFqKjfSX
# Vjh6MuaUcaq22z9FIs6KQp905hxWU/PIABHT2TdX2QGEnpajvBimQ0XQBSlSw0ar
# 7+QTqsixVbg/ypKCjys2Lc6V1+L+jci14V8vZ2217uBx3p4HMNFl2e4oKU11vEmL
# OB0ZWQqtvrd1SZgSW7XQEdKSIsFXxLEzbQu4aIESUEj35h3ASopyfhOqUNlbVZqZ
# by+1Ydz8hnV6++UzDERwoS3gMLx1fbvsnVWxFtZMAoKIC2KxpnZ4D214IUjtCrke
# pPZpKssX4Cdu1uqBjTcv+cKQB4lzXrvfmgK8M77/Df4ty6sxAWeaUm0bPIHj9gDR
# IyGSePtBV4tLfNtUrMijWVUaFgvHZ1oqjGoqm6qCQkxuTQSs+1HcOzzSbFDgE5pS
# WGFBe9iSFq7DOtjFgr5P+l8aSMRqyJosRJFjyNozlqGsqtSUaelzj2FJOWXrUNpy
# fnSWUBqLpWbygbRM+EhS
